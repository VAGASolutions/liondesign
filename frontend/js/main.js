...
const TRANSLATIONS = {
  en: {
    ...
    'hero.title': 'We craft digital<br />experiences that<br /><span class="highlight">convert.</span>',
    ...
    'services.title': 'End-to-end digital<br />excellence',
    ...
    's1.f1': 'Custom UI / UX Design',
    's1.f2': 'Responsive & mobile-first',
    's1.f5': 'CMS & e-commerce integration',
    's2.title': 'SEO & Growth',
    's2.desc': 'Data-driven strategies that push you to the top of search results and keep you there sustainably.',
    's2.f1': 'Technical SEO audit',
    's2.f2': 'Keyword research & strategy',
    's2.f3': 'On-page & schema markup',
    's2.f4': 'Link building campaigns',
    's2.f5': 'Monthly reporting',
    ...
    's3.f1': 'Logo & visual identity',
    's3.f2': 'Design system creation',
    's3.f3': 'Brand guidelines',
    's3.f4': 'Motion & animation',
    's3.f5': 'Print & digital assets',
    'stats.p1': 'Projects delivered',
    'stats.p2': 'Client satisfaction',
    'stats.p3': 'In the industry',
    'stats.p4': 'Revenue generated for clients',
    'process.label': 'How we work',
    'process.title': 'Simple, proven process',
    'process.sub': 'From first call to launch in four clear steps — no surprises, no drama.',
    'process.s1.title': 'Discovery',
    'process.s1.desc': 'Deep-dive into your goals, audience, and competition to build a rock-solid strategy.',
    'process.s2.title': 'Design',
    'process.s2.desc': 'Wireframes → high-fidelity mockups → interactive prototype. You approve every pixel.',
    'process.s3.title': 'Build & Audit',
    'process.s3.desc': 'Development alongside security and SEO audits baked in — not bolted on afterwards.',
    'process.s4.title': 'Launch & Grow',
    'process.s4.desc': 'Smooth deployment, post-launch monitoring, and continuous improvement to keep you ahead.',
    'portfolio.label': 'Selected work',
    'portfolio.title': "Projects we're proud of",
    'tag.web': 'Web Design',
    'tag.brand': 'Brand Identity',
    'tag.web2': 'Web Design',
    'testimonials.label': 'Client love',
    ...
    'contact.response.value': 'Within a business day',
    'form.firstname': 'First name',
    'form.firstname.ph': 'Alex',
    'form.lastname': 'Last name',
    'form.lastname.ph': 'Johnson',
    'form.email': 'Email address',
    'form.service': 'Service needed',
    'form.service.ph': 'Select a service…',
    'form.fullpart': 'Full Partnership',
    'form.budget': 'Budget range',
    'form.budget.ph': 'Select budget…',
    'form.b1': 'Under $1,000',
    'form.retainer': 'Monthly retainer',
  ...
  hu: {
    ...
    'nav.cta': 'Projekt indítása',
    'hero.badge': 'Elérhető új projektekre · 2026',
    'hero.title': 'Digitális élményeket<br />alkotunk, amelyek<br /><span class="highlight">konvertálnak.</span>',
    ...
    'hero.cta1': 'Munkáink megtekintése',
    'hero.cta2': 'Ingyenes audit',
    'hero.scroll': 'Görgetés',
    'services.label': 'Mit csinálunk',
    'services.title': 'Végponttól végpontig<br />digitális kiválóság',
    ...
    's1.f1': 'Egyedi UI / UX tervezés',
    's1.f2': 'Reszponzív és mobilbarát',
    's1.f5': 'CMS és e-kereskedelmi integráció',
    ...
    's2.f1': 'Technikai SEO audit',
    's2.f2': 'Kulcsszókutatás és stratégia',
    's2.f3': 'On-page és séma jelölés',
    's2.f4': 'Linképítési kampányok',
    's2.f5': 'Havi jelentések',
    ...
    's3.f1': 'Logó és vizuális identitás',
    's3.f2': 'Dizájnrendszer alkotás',
    's3.f3': 'Márka arculati kézikönyv',
    's3.f4': 'Mozgás és animáció',
    's3.f5': 'Nyomtatott és digitális anyagok',
    'stats.p1': 'Elkészített projekt',
    'stats.p2': 'Ügyfélelégedettség',
    'stats.p3': 'Iparági tapasztalat',
    'stats.p4': 'Ügyfeleknek generált bevétel',
    'process.label': 'Hogyan dolgozunk',
    'process.title': 'Egyszerű, bevált folyamat',
    'process.sub': 'Az első hívástól az indításig négy egyértelmű lépésben — meglepetések és dráma nélkül.',
    'process.s1.title': 'Felfedezés',
    'process.s1.desc': 'Mélyreható elemzés a céljaidról, közönségedről és versenytársaidról, hogy szilárd stratégiát építsünk.',
    'process.s2.title': 'Tervezés',
    'process.s2.desc': 'Drótváz → részletes mockup → interaktív prototípus. Te hagyod jóvá minden pixelt.',
    'process.s3.title': 'Fejlesztés és audit',
    'process.s3.desc': 'Fejlesztés biztonsági és SEO auditokkal párhuzamosan — nem utólag rárakva.',
    'process.s4.title': 'Indítás és növekedés',
    'process.s4.desc': 'Zökkenőmentes üzembe helyezés, indítás utáni monitorozás és folyamatos fejlesztés, hogy megtartsd az előnyöd.',
    'portfolio.label': 'Kiválasztott munkák',
    'portfolio.title': 'Büszke projektjeink',
    'tag.web': 'Webdesign',
    'tag.brand': 'Márkaidentitás',
    'tag.web2': 'Webdesign',
    'testimonials.label': 'Ügyfeleink mondják',
    ...
    'contact.title': 'Építsünk valami nagyszerűt',
    ...
    'contact.location.label': 'Helyszín',
    'contact.location.value': 'Távoli — worldwide ügyfeleket szolgálunk',
    'contact.response.label': 'Válaszidő',
    'contact.response.value': 'Egy munkanapon belül',
    'form.firstname': 'Keresztnév',
    'form.firstname.ph': 'Alex',
    'form.lastname': 'Vezetéknév',
    'form.lastname.ph': 'Nagy',
    'form.email': 'E-mail cím',
    'form.service': 'Szükséges szolgáltatás',
    'form.service.ph': 'Válasszon szolgáltatást…',
    'form.fullpart': 'Teljes partnerség',
    'form.budget': 'Büdzsé',
    'form.budget.ph': 'Büdzsé kiválasztása…',
    'form.b1': '350 000 Ft alatt',
    'form.retainer': 'Havi megbízás',
    ...
    'footer.col1': 'Szolgáltatások',
    'footer.col2': 'Cég',
    'footer.process': 'Folyamatunk',
    'footer.testimonials': 'Vélemények',
    'footer.col3': 'Jogi',
...
(function initLang() {
  ...
  if (btn) btn.addEventListener('click', () => {
    setLang(document.documentElement.lang === 'hu' ? 'en' : 'hu');
  });
})()
